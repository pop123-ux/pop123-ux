...
| **Visual Scrambling — [LeNet-5](https://github.com/pop123-ux/LeNet_5-from-scratch) · [AlexNet](https://github.com/pop123-ux/AlexNet-from-scratch) · [ResNet Family](https://github.com/pop123-ux/ResNet_Family-from-scratch)** | An ongoing series reconstructing landmark vision architectures from first principles, currently spanning LeNet-5, AlexNet, and the ResNet family, with further architectures planned | PyTorch · CNNs · Computer Vision · CI |
